...
onMounted(() => {
    ...
    const handleScrollProgress = () => {
        ...
        if (rect.top <= window.innerHeight) {
            progress.Python = '80%'// 滾動到視窗範圍內時更新寬度
            progress.SQL = '80%'
            progress.Linux = '60%'
            progress.Flask = '65%'
            progress.Data = '75%'
    ...
    <section id="skills" class="skills section-bg">
        <div class="container">
            <div class="section-title">
                <h2>Skills</h2>
                <p style="font-weight: 900;">一名熱枕於AI技術的工程師。以下是我掌握的技術和工具</p>
                    ...
                    <div class="row skills-content">
                        <div class="col-lg-6" data-aos="fade-up">
                            ...
                            <div class="progress">
                                ...
                                <div class="progress-bar-wrap">
                                    <div class="progress-bar" :style="{ width: progress.SQL }" role="progressbar"
                                        aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="progress">
                                ...
                                <div class="progress-bar-wrap">
                                    <div class="progress-bar" :style="{ width: progress.Linux }" role="progressbar"
                                        aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="progress">
                                <span class="skill">Data Mining<i class="val">75%</i></span>
                                <div class="progress-bar-wrap">
                                    <div class="progress-bar" :style="{ width: progress.Data }" role="progressbar"
                                        aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="progress">
                                <span class="skill">GCP<i class="val">70%</i></span>
                                <div class="progress-bar-wrap">
